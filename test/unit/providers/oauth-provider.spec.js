...
describe('OAuthProvider', function() {
  ...
  describe('$get()', function() {
    ...
    describe('getAccessToken()', function() {
      ...
      it('should call `queryStringStringify`', inject(function(OAuth) {
        ...
        queryStringStringify.callCount.should.equal(1);
        queryStringStringify.firstCall.args.should.have.lengthOf(1);
        queryStringStringify.firstCall.args[0].should.eql({
          client_id: defaults.clientId,
          grant_type: 'password',
          username: 'foo',
          password: 'bar',
    ...
    describe('refreshToken()', function() {
      ...
      it('should call `queryStringStringify`', inject(function(OAuth, OAuthToken) {
        sinon.spy(queryString, 'stringify');
      ...
      it('should return an error if `refresh_token` is missing', inject(function($httpBackend, OAuth) {
        $httpBackend.expectPOST(defaults.baseUrl + defaults.grantPath, queryStringStringify(_.assign({}, data, { 'refresh_token': undefined })))
      ...
      it('should return an error if `refresh_token` is invalid', inject(function($httpBackend, OAuth, OAuthToken) {
        ...
        $httpBackend.expectPOST(defaults.baseUrl + defaults.grantPath, queryStringStringify(data))
          .respond(400, { error: 'invalid_grant' });
    ...
    describe('revokeToken()', function () {
      ...
      it('should call `queryStringStringify` with `access_token` if `refresh_token` is not available', inject(function(OAuth, OAuthToken) {
        sinon.spy(queryString, 'stringify');
